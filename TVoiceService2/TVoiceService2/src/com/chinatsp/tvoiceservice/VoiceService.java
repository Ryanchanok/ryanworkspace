...
import com.chinatsp.tvoiceservice.client.IFlyTtsClient;
...
public class VoiceService extends Service {
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        try {
            VoiceClientInterfaceImpl clientInterface = (VoiceClientInterfaceImpl) mBinder.getVoiceClient();
            clientInterface.onServiceDestroy();
    ...
    private class VoiceClientInterfaceImpl extends IVoiceClientInterface.Stub {
        ...
        public void speak(String arg0) throws RemoteException {
            // TODO Auto-generated method stub
            if (mTtsServiceAgent!=null){
                mTtsServiceAgent.startSpeak(arg0);
            }
        }
